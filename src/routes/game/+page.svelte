<script>
    ...
    let gameData = [
        ...
        {
            text: "Attention : Plusieurs IST peuvent être transmises lors d’un cunnilingus[Définition] ou d’une fellation, comme la chlamydiose, l’hépatite B, la syphilis, l’herpès ou l'infection à papillomavirus (HPV).",
            actions: [
                {
